...
Soul Room delegates interactive SSH to ShellHub. This keeps SSH keys,
...
```text
SOULROOM_SHELLHUB_URL=https://shellhub.example.com
```
...
In Soul Room, open **Remote access**, select the device, and save that SSHID.
Every web-terminal or SSH-command request is then authorized by Soul Room
...
passwords or reusable private keys in Soul Room.
